        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                if (!request.getServletPath().equals("/usuario/login") && !request.getServletPath().equals("/usuario/crear")) {
                    out.println("<div>\n"
                            + "		<a href=\"#\">HOME</a>  \n"
                            + "		<a href=\" " + request.getContextPath() + "/insertarEmpleado" + "\">insertar Empleado</a>  \n"
                            + "		<a href=\"" + request.getContextPath() + "/ConsultarEmpleado" + "\">consultar Empleado</a>  \n"
                            + "		<a href=\"" + request.getContextPath() + "/Proveedor" + "\">Insertar Proveedor</a>  \n"
                            + "		<a href=\"" + request.getContextPath() + "/ConsultarProveedor" + "\">Consultar Proveedor</a>  \n"
                            + "		<a href=\"" + request.getContextPath() + "/Producto" + "\">Insertar Producto</a>  \n"
                            + "		<a href=\"" + request.getContextPath() + "/ConsultarProducto" + "\">Consultar Producto</a>  \n"
                            + "		<a href=\"" + request.getContextPath() + "/InsertarFactura" + "\">Insertar Factura</a>  \n"
                            + "		<a href=\"" + request.getContextPath() + "/ConsultarFactura" + "\">Consultar Factura</a>  \n"
                            + "		<a href=\"" + request.getContextPath() + "/InsertarDetalleFactura" + "\">Insertar Detalle Factura</a>  \n"
                            + "		<a href=\"" + request.getContextPath() + "/ConsultarDetalleFactura" + "\">Consultar Detalle Factura</a>  \n"
